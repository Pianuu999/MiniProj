...
function Navbar() {
    ...
    return (
        ...
        >
            ...
            >
                <rect width={1440} height={125} fill="#252525" />
            </svg>
            <div
                style={{
                    display: "flex",
            ...
            >
                <div
                    style={{
                        ...
                        background: activeButton === 'Home' ? "#fafafa" : "transparent",
                        cursor: "pointer",
                    }}
                    ...
                    <Link to="/List" style={{ textDecoration: 'none' }}>
                        <p
                            style={{
                                ...
                                fontSize: 24,
                                textAlign: "center",
                                color: activeButton === 'Home' ? "#252525" : "#fafafa",
                            }}
                        >
                            Home
                        </p>
                ...
                <div
                    style={{
                        ...
                        borderTopLeftRadius: 25,
                        borderTopRightRadius: 25,
                        background: activeButton === 'Memory Test' ? "#fafafa" : "transparent",
                        cursor: "pointer",
                    }}
                    onClick={() => handleButtonClick('Memory Test')}
                >
                    <Link to="/memory-test" style={{ textDecoration: 'none' }}>
                        <p
                            style={{
                                flexGrow: 0,
                                flexShrink: 0,
                                fontSize: 24,
                                textAlign: "center",
                                color: activeButton === 'Memory Test' ? "#252525" : "#fafafa",
                            }}
                        >
                            <span>Memory</span><br /><span>Test</span>
                        </p>
                    </Link>
                </div>
                <div
                    style={{
                        ...
                        borderTopLeftRadius: 25,
                        borderTopRightRadius: 25,
                        background: activeButton === 'Potato Eat' ? "#fafafa" : "transparent",
                        cursor: "pointer",
                    }}
                    onClick={() => handleButtonClick('Potato Eat')}
                >
                    <Link to="/potato-eat" style={{ textDecoration: 'none' }}>
                        <p
                            style={{
                                flexGrow: 0,
                                flexShrink: 0,
                                fontSize: 24,
                                textAlign: "center",
                                color: activeButton === 'Potato Eat' ? "#252525" : "#fafafa",
                            }}
                        >
                            <span>Potato</span><br /><span>Eat</span>
                        </p>
                    </Link>
                </div>
                <div
                    style={{
                        ...
                        borderTopLeftRadius: 25,
                        borderTopRightRadius: 25,
                        background: activeButton === 'Market' ? "#fafafa" : "transparent",
                        cursor: "pointer",
                    }}
            ...
            <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                style={{ width: 22, height: 36, position: "absolute", left: 125, top: 47 }}
                preserveAspectRatio="none"
            >
                <g clip-path="url(#clip0_2102_126)">
                    <path

    ...
    return (
        ...
        >
            <div style={{ width: "100%", height: "160px", position: "relative"}}>
                ...
                >
                    <path d="M0 0H1440V160H0V0Z" fill="#0D0D0D" />
                </svg>
                <p
                    style={{
                       position: "absolute",
                ...
                <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    style={{ width: 22, height: 36, position: "absolute", left: 593, top: 66 }}
                    preserveAspectRatio="none"
                >
                    <g clip-path="url(#clip0_43_111)">
                        ...
                        />
                        <path
                            d="M7.16154 27.5958C6.97931 27.5863 6.797 27.613 6.62546 27.6743C6.45392 27.7356 6.29665 27.8302 6.16302 27.9526C6.02939 28.0749 5.92213 28.2225 5.84761 28.3865C5.77309 28.5505 5.73284 28.7275 5.72925 28.9072V33.067C5.72925 33.4297 5.87562 33.7777 6.13617 34.0342C6.39672 34.2907 6.7501 34.4348 7.11857 34.4348C7.48704 34.4348 7.84042 34.2907 8.10097 34.0342C8.36152 33.7777 8.50789 33.4297 8.50789 33.067V28.9636C8.51362 28.7877 8.48373 28.6126 8.41998 28.4482C8.35623 28.2839 8.25989 28.1337 8.13658 28.0064C8.01326 27.879 7.86544 27.7772 7.70173 27.7067C7.53802 27.6362 7.36169 27.5985 7.18302 27.5958H7.16154Z"
                            fill="#5E60CE"
                        />
                        <path
